  ...
  const content = `
    ...
    <div style="background-color: #f8fafc; border-left: 4px solid #00466a; padding: 16px; margin: 0 0 32px 0;">
      ...
      <ol style="margin: 0; padding-left: 20px; color: #475569; line-height: 1.6;">
        ...
        <li>When prompted for your <strong>Registration Key</strong>, enter the code below to initialize your local database and sync with our central platform.</li>
      </ol>
    </div>

    <div style="text-align: center; margin: 0 0 32px 0; padding: 24px; background-color: #f1f5f9; border-radius: 8px;">
      <span style="display: block; font-size: 14px; color: #64748b; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 1px;">Your Registration Key</span>
      <strong style="color: #0f172a; font-size: 24px; font-family: monospace; letter-spacing: 2px;">${registrationKey}</strong>
    </div>
    ...
    <p style="font-size: 14px; color: #b91c1c; font-weight: 500; line-height: 1.5; margin: 0 0 32px 0; padding: 12px 16px; background-color: #fef2f2; border-radius: 6px; border: 1px solid #fecaca;">
      <strong style="color: #991b1b;">Security Warning:</strong> Do not share this registration key with anyone. It acts as the master password to initialize your LGU's database.
    </p>
